...
export default function ResultScreen() {
    ...
    const getOriginalIndex = useCallback((sortedItem: CalculationResult) => {
            ...
            <View className="gap-y-3">
                ...
                >
                    ...
                    <Text className={`text-base ${
                        sortBy === 'ranking' ? 'text-blue-600 font-medium' : 'text-gray-600'
                    }`}>
                    ...
                    <View key={result.id} className="mb-3">
                        ...
                        <View className="bg-gray-200 rounded-full h-2 overflow-hidden">
                            <Animated.View 
                                ...
                                style={{
                                    width: animatedValues.current[originalIndex]?.interpolate({
                                        inputRange: [0, 1],
            ...
            <View className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <View className="bg-gray-50 flex-row border-b border-gray-200">
                    ...
                    <View className="flex-1 p-4">
                        <Text className="font-semibold text-gray-800 text-center">Nama</Text>
                    </View>
                </View>
                
                {sortedResults.map((result, index) => (
                    <View key={result.id} className="flex-row border-b border-gray-100 last:border-b-0">
                        <View className="w-16 p-4 border-r border-gray-200">
                    ...
                    <View className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 max-w-sm w-full">
                        <View className="items-center">
                            ...
                            <Text className="text-gray-600 text-center leading-5">
                                Sedang menghitung rekomendasi berdasarkan kriteria yang dipilih...
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                <View className="flex-1 justify-center items-center px-6">
                    <View className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 max-w-sm w-full">
                        <View className="items-center">
                            ...
                            <Text className="text-gray-600 text-center leading-5">
                                Belum ada data rekomendasi yang tersedia. Silakan cek kembali kriteria yang dipilih.
                            </Text>
                        </View>
                    </View>
                </View>
                    ...
                    <View className="flex-1 justify-center items-center px-6 py-8">
                        <View className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 max-w-sm w-full">
                            <View className="items-center">
                                ...
                                <Text className="text-gray-600 text-center leading-5">
                                    Silakan pilih format tampilan (grafik atau tabel) di pengaturan filter untuk melihat hasil rekomendasi.
                                </Text>
                            </View>
                        </View>
                    </View>
