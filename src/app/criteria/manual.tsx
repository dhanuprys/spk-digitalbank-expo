import { Pressable, ScrollView, Text, TouchableHighlight, View, FlatList } from "react-native";
            ...
            <View className="px-6 py-6 bg-white border-t border-gray-100">
                <Pressable onPress={() => router.push('/criteria/filter')}>
                    <View className="bg-blue-500 py-2 rounded-xl flex-row items-center justify-center gap-x-3 shadow-md">
                        ...
                        <Text className="text-white font-semibold text-base">LANJUTKAN</Text>
                    </View>
                </Pressable>
                
                <Text className="text-center text-gray-500 text-sm mt-4 px-4 leading-5">
                    Setelah mengatur urutan kriteria, lanjutkan ke tahap berikutnya untuk mengatur hasil rekomendasi
                </Text>
            </View>
        </SafeAreaView>
    );
