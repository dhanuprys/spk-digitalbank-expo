          ...
          <View className='space-y-2'>
            <View className='flex-row items-center gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <View className='flex-1'>
                ...
                <Text className='text-gray-600 text-xs'>
                  Perhitungan otomatis berdasarkan urutan
                </Text>
              </View>
            </View>
            ...
            <View className='flex-row items-center gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <View className='flex-1'>
                ...
                <Text className='text-gray-600 text-xs'>
                  Input nilai langsung untuk setiap kriteria
                </Text>
              </View>
            </View>
            ...
            <View className='flex-row items-center gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <View className='flex-1'>
                ...
                <Text className='text-gray-600 text-xs'>
                  Grafik dan tabel untuk evaluasi
                </Text>
              </View>
            </View>
            ...
            <View className='flex-row items-center gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <View className='flex-1'>
                ...
                <Text className='text-gray-600 text-xs'>
                  Pengaturan urutan kriteria yang mudah
                </Text>
              </View>
            </View>
          </View>
          ...
          <View className='space-y-2'>
            <View className='flex-row items-start gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <Text className='flex-1 text-gray-700 text-sm'>
                Pilih metode perhitungan (MAGIQ atau Manual)
              </Text>
            </View>
            ...
            <View className='flex-row items-start gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <Text className='flex-1 text-gray-700 text-sm'>
                Atur kriteria dan nilai sesuai kebutuhan
              </Text>
            </View>
            ...
            <View className='flex-row items-start gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <Text className='flex-1 text-gray-700 text-sm'>
                Sistem menghitung dan memberikan rekomendasi
              </Text>
            </View>
            ...
            <View className='flex-row items-start gap-x-3 p-3 bg-gray-50 rounded-lg'>
              ...
              <Text className='flex-1 text-gray-700 text-sm'>
                Lihat hasil dalam grafik atau tabel
              </Text>
            </View>
          </View>
        </View>
